...
export default function Home() {
  return (
    <div className="min-h-dvh flex flex-col justify-center gap-16 md:flex-col">
      ...
      <div className="flex gap-5 items-stretch flex-col md:flex-row">
        <div className="flex-1 bg-gray-700 border-gray-600 rounded-2xl p-8 space-y-6">
          <div className="flex justify-between items-center">
            ...
            <span className="text-purple font-sans font-semibold text-xs flex items-center gap-2 uppercase">
